...
#ifdef CONFIG_SCSI_UFS_ENHANCED_INLINE_CRYPTO_V3
		bio->hisi_bio.metadata = fio->metadata;
#endif
...
#endif
#ifdef CONFIG_SCSI_UFS_ENHANCED_INLINE_CRYPTO_V3
	else if ((io->bio) && (io->bio->hisi_bio.metadata != fio->metadata))
		__submit_merged_bio(io);
#endif
#ifdef CONFIG_F2FS_TURBO_ZONE_V2
	else if ((io->bio) && (io->bio->hisi_bio.flags != fio->flags))
		__submit_merged_bio(io);
#endif
...
alloc_new:
...
#ifdef CONFIG_SCSI_UFS_ENHANCED_INLINE_CRYPTO_V3
		io->bio->hisi_bio.metadata = fio->metadata;
#endif
		if (fio->ci_key)
			io->bio->hisi_bio.index = bio_page->index;
#endif
#ifdef CONFIG_F2FS_TURBO_ZONE_V2
		io->bio->hisi_bio.flags = fio->flags;
#endif
	}
#ifdef CONFIG_F2FS_FS_ENCRYPTION
	f2fs_bug_on(sbi, (io->bio->hisi_bio.ci_key != fio->ci_key) ||
			(io->bio->hisi_bio.ci_key_len != fio->ci_key_len));
#ifdef CONFIG_SCSI_UFS_ENHANCED_INLINE_CRYPTO_V3
	f2fs_bug_on(sbi, io->bio->hisi_bio.metadata != fio->metadata);
#endif
#endif
...
#ifdef CONFIG_SCSI_UFS_ENHANCED_INLINE_CRYPTO_V3
		bio->hisi_bio.metadata = fscrypt_metadata(inode);
#endif
		bio->hisi_bio.index = page->index;
	}
#endif
...
#ifdef CONFIG_SCSI_UFS_ENHANCED_INLINE_CRYPTO_V3
		fio->metadata = fscrypt_metadata(inode);
#endif
#endif
	}
	return 0;
