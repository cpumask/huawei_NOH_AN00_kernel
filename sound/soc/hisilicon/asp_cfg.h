...
#define RST_ASP_H2X_BIT               BIT(ASP_CFG_RST_ASP_H2X_N_OFFSET)
#define RST_ASP_AUDIO_PLL_BIT         BIT(ASP_CFG_GT_AUDIO_PLL_OFFSET)
#define RST_HDMIBCLK_BIT              BIT(ASP_CFG_GT_HDMIBCLK_OFFSET)
#define RST_HDMIBCLK_BIT              BIT(ASP_CFG_GT_HDMIBCLK_OFFSET)
#define RST_SIO_AUDIO_BIT             BIT(ASP_CFG_RST_SIO_AUDIO_N_OFFSET)
#define RST_SIO_VOICE_BIT             BIT(ASP_CFG_RST_SIO_VOICE_N_OFFSET)
#define RST_SIO_BT_BIT                BIT(ASP_CFG_RST_SIO_BT_N_OFFSET)
#define RST_SIO_MODEM_BIT             BIT(ASP_CFG_RST_SIO_MODEM_N_OFFSET)
#define RST_ASP_HDMI_BIT              BIT(ASP_CFG_RST_ASP_HDMI_N_OFFSET)
#define RST_SRCUP_BIT                 BIT(ASP_CFG_RST_SRC_UP_N_OFFSET)
#define RST_SRCDOWN_BIT               BIT(ASP_CFG_RST_SRC_DOWN_N_OFFSET)
#define RST_DMAC_BIT                  BIT(ASP_CFG_RST_DMAC_N_OFFSET)
#define RST_SLIMBUS_BIT               BIT(ASP_CFG_RST_SLIMBUS_N_OFFSET)
#define RST_SLIMBUS_BASE_BIT          BIT(ASP_CFG_RST_SLIMBUS_BASE_N_OFFSET)

#define CLK_AUDIO_PLL_BIT             BIT(ASP_CFG_GT_AUDIO_PLL_OFFSET)
#define CLK_HDMI_HCLK_BIT             BIT(ASP_CFG_GT_HDMIHCLK_OFFSET)
#define CLK_HDMI_BCLK_BIT             BIT(ASP_CFG_GT_HDMIBCLK_OFFSET)
#define CLK_HDMI_MCLK_BIT             BIT(ASP_CFG_GT_ASP_H2X_OFFSET)
#define CLK_SLIMBUSH_BIT              BIT(ASP_CFG_GT_SLIMBUSHCLK_OFFSET)
#define CLK_SLIMBUS_BASE_BIT          BIT(ASP_CFG_GT_SLIMBUS_BASE_CLK_OFFSET)
#define CLK_SPDIF_HCLK_BIT            BIT(ASP_CFG_GT_SPDIFCLK_OFFSET)
#define CLK_GT_SPDIF_BIT              BIT(ASP_CFG_GT_SPDIF_OFFSET)

#define ASP_CFG_ASP_HDMI_INT_OFFSET    0

#define CONSUMER_ASP                   1
