...
#define HWLOG_TAG_DEFALUT_LEVEL (HWLOG_ERR | HWLOG_WARNING | HWLOG_INFO)
...
#define hwlog_debug1(x...)       _hwlog_debug1(HWLOG_TAG, ##x)
#define _hwlog_debug1(TAG, x...) __hwlog_debug1(TAG, ##x)
...
#define hwlog_debug2(x...)       _hwlog_debug2(HWLOG_TAG, ##x)
#define _hwlog_debug2(TAG, x...) __hwlog_debug2(TAG, ##x)
...
#define hwlog_debug3(x...)       _hwlog_debug3(HWLOG_TAG, ##x)
#define _hwlog_debug3(TAG, x...) __hwlog_debug3(TAG, ##x)
...
#define hwlog_debug4(x...)       _hwlog_debug4(HWLOG_TAG, ##x)
#define _hwlog_debug4(TAG, x...) __hwlog_debug4(TAG, ##x)
