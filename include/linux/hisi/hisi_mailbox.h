...
#define IPCMBxSOURCE(mdev) ((mdev) << 7)
#define IPCMBxDSET(mdev) (((mdev) << 7) + 0x04)
#define IPCMBxDCLR(mdev) (((mdev) << 7) + 0x08)
#define IPCMBxDSTATUS(mdev) (((mdev) << 7) + 0x0C)
#define IPCMBxMODE(mdev) (((mdev) << 7) + 0x10)
#define IPCMBxIMASK(mdev) (((mdev) << 7) + 0x14)
#define IPCMBxICLR(mdev) (((mdev) << 7) + 0x18)
#define IPCMBxSEND(mdev) (((mdev) << 7) + 0x1C)
#define IPCMBxDATA(mdev, index) (((mdev) << 7) + 0x20 + ((index) << 2))
#define IPCCPUxIMST(cpu, mdev) (((cpu) << 3) + 0x8000 + (((mdev) / 32) << 8))
#define IPCCPUxIRST(cpu, mdev) (((cpu) << 3) + 0x8004 + (((mdev) / 32) << 8))
