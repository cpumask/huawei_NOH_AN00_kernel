...
#else
static int soh_get_acr_resistance(struct acr_info *r,  enum acr_type type)
{
	return 0;
}
static int soh_get_dcr_resistance(struct dcr_info *r)
{
	return 0;
}
static int soh_get_poweroff_leakage(struct pd_leak_current_info *i)
{
	return 0;
}
...
static int hisi_soh_register_blocking_notifier(struct notifier_block *nb)
{
	return 0;
}

static int hisi_soh_unregister_blocking_notifier(struct notifier_block *nb)
{
	return 0;
}

static int hisi_call_soh_blocking_notifiers(int val, void *v)
{
	return 0;
}

#endif /* CONFIG_HISI_SOH */
