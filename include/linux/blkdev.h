...
#define req_tz(req) ((req)->hisi_req.hisi_featrue_flag & CUST_REQ_TURBO_ZONE)

#define req_order(req) \
		((req)->hisi_req.hisi_featrue_flag & CUST_REQ_ORDER)
...
static inline char *hisi_blk_prefix_str(enum blk_dump_scene s)
{
...
#ifdef CONFIG_HYPERHOLD_CORE
extern void blk_mq_tagset_health_query_register(
	struct blk_mq_tag_set *tag_set, lld_query_health_fn func);
extern int blk_lld_health_query(struct block_device *bi_bdev,
	u8 *pre_eol_info, u8 *life_time_est_a, u8 *life_time_est_b);
#endif
...
extern int blk_busyidle_event_subscribe(const struct block_device *bi_bdev,
	const struct blk_busyidle_event_node *event_node);
extern int blk_queue_busyidle_event_subscribe(
	const struct request_queue *q,
	const struct blk_busyidle_event_node *event_node);
extern int blk_lld_busyidle_event_subscribe(
	const struct blk_dev_lld *lld,
	struct blk_busyidle_event_node *event_node);
extern int blk_busyidle_event_unsubscribe(
	const struct blk_busyidle_event_node *event_node);
extern int blk_queue_busyidle_event_unsubscribe(
	const struct blk_busyidle_event_node *event_node);
extern void blk_queue_busyidle_enable(
	const struct request_queue *q, int enable);
extern void blk_mq_tagset_busyidle_enable(
...
extern int blk_flush_async_support(const struct block_device *bi_bdev);
extern void blk_mq_tagset_ufs_mq_iosched_enable(
	struct blk_mq_tag_set *tag_set, int enable);
extern bool ufs_order_panic_wait_datasync_handle(struct blk_dev_lld *blk_lld);
extern void ufs_order_panic_datasync_handle(struct blk_dev_lld *blk_lld);
extern void blk_power_off_flush(int emergency);
extern void hisi_blk_panic_flush(void);
extern void blk_write_throttle(struct request_queue *queue, int level);
...
extern void blk_lld_idle_notify(const struct blk_dev_lld *lld);
extern bool blk_dev_write_order_preserved(struct block_device *bdev);
extern unsigned int blk_req_get_order_nr(struct request *req, bool extern_protect);
extern void blk_queue_order_enable(struct request_queue *q, bool enable);
extern bool blk_queue_query_order_enable(struct request_queue *q);
extern void blk_order_nr_reset(struct blk_mq_tag_set *tag_set);
extern int blk_mq_get_io_in_list_count(struct block_device *bdev);
#ifdef CONFIG_HISI_QOS_MQ
extern void blk_mq_tagset_ufs_qos_mq_iosched_enable(
	struct blk_mq_tag_set *tag_set, int enable);
static __always_inline unsigned int qos_ufs_mq_get_send_cpu(struct request *rq)
{
	return rq->hisi_req.slot_cpu;
}
#endif /* CONFIG_HISI_QOS_MQ */
...
static inline int blk_lld_tz_query(struct block_device *bi_bdev, u8 *buf, u32 buf_len)
{
	return 0;
}
...
static inline int blk_lld_tz_ctrl(
	struct block_device *bi_bdev, int desc_id, uint8_t index)
{
	return 0;
}
#ifdef CONFIG_HYPERHOLD_CORE
static inline void blk_mq_tagset_health_query_register(
	struct blk_mq_tag_set *tag_set, lld_query_health_fn func)
{
}
static inline int blk_lld_health_query(struct block_device *bi_bdev,
	u8 *pre_eol_info, u8 *life_time_est_a, u8 *life_time_est_b)
{
	return 0;
}
...
static inline int blk_busyidle_event_subscribe(
	struct block_device *bi_bdev,
	struct blk_busyidle_event_node *event_node)
{
	return 0;
}
static inline int blk_lld_busyidle_event_subscribe(
	struct blk_dev_lld *lld, struct blk_busyidle_event_node *event_node)
{
	return 0;
}
static inline int blk_queue_busyidle_event_subscribe(
	struct request_queue *q, struct blk_busyidle_event_node *event_node)
{
	return 0;
}
static inline int blk_busyidle_event_unsubscribe(
	struct blk_busyidle_event_node *event_node)
{
	return 0;
}
static inline int blk_queue_busyidle_event_unsubscribe(
	struct blk_busyidle_event_node *event_node)
{
	return 0;
}
static inline void blk_queue_busyidle_enable(
	struct request_queue *q, int enable)
{
}
static inline void blk_mq_tagset_busyidle_enable(
	struct blk_mq_tag_set *tag_set, int enable)
{
}
...
static inline bool ufs_order_panic_wait_datasync_handle(struct blk_dev_lld *blk_lld)
{
	return false;
}
static inline void ufs_order_panic_datasync_handle(struct blk_dev_lld *blk_lld)
{
}
static inline void hisi_blk_panic_flush(void)
{
}
...
static inline bool blk_dev_write_order_preserved(struct block_device *bdev)
{
	return false;
}
static inline unsigned int blk_req_get_order_nr(struct request *req, bool extern_protect)
{
	return 0;
}
static inline void blk_write_throttle(
			struct request_queue *queue,int level)
{
}
...
static inline void blk_order_nr_reset(struct blk_mq_tag_set *tag_set)
{
}
static inline int blk_mq_get_io_in_list_count(struct block_device *bdev)
{
	return 0;
}
static unsigned char req_get_streamid(struct request *req)
...
static inline void blk_lld_idle_notify(const struct blk_dev_lld *lld)
{
}
