...
static int hi_gps_probe(struct platform_device *pdev)
{
    ...
    hi_gps_info->pctrl = devm_pinctrl_get(gps_power_dev); //lint !e64 屏蔽pclint无法识别返回值类型
    ...
    hi_gps_info->pins_normal = pinctrl_lookup_state(hi_gps_info->pctrl, "default"); //lint !e64
    ...
    hi_gps_info->pins_idle = pinctrl_lookup_state(hi_gps_info->pctrl, "idle"); //lint !e64 屏蔽pclint无法识别返回值类型
    ...
    g_gps_ref_clk = hi_gps_info->refclk;
    ...
    g_gps_mux_clk = hi_gps_info->muxclk;
    ...
    g_mdm2gps_clk0 = hi_gps_info->mdmclk0;
    ...
    g_mdm2gps_clk1 = hi_gps_info->mdmclk1;
    ...
    g_mdm2gps_clk2 = hi_gps_info->mdmclk2;
