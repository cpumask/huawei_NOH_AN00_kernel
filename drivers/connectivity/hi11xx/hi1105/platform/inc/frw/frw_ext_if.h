...
#define frw_timer_restart_timer_m(_pst_timeout, _ul_timeout, _en_is_periodic) \
...
#define frw_timer_create_timer_m(_pst_timeout, _p_timeout_func, _ul_timeout, \
...
typedef struct {
    ...
    oal_uint8 auc_event_data[4];     /* payload 4data */
} frw_event_stru;
