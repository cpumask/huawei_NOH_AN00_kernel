 ...
 */
extern void mem_trace_init(void);
 ...
 */
extern void mem_trace_exit(void);
 ...
 */
extern void mem_trace_info_show(uint32_t ul_mode,
                                uint32_t ul_fileid,
                                uint32_t ul_line);
 ...
 */
extern void __mem_trace_add_node(uintptr_t ul_addr,
                                 uint32_t ul_fileid,
                                 uint32_t ul_linenum);
 ...
 */
extern void __mem_trace_delete_node(uintptr_t ul_addr,
                                    uint32_t ul_fileid,
                                    uint32_t ul_linenum);
 ...
 *        最后到达的位置
 */
extern void __mem_trace_probe(uintptr_t ul_addr,
