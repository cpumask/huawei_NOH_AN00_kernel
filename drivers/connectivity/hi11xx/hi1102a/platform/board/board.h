...
/* EXTERN VARIABLE */
extern DOWNLOAD_MODE g_device_download_mode_list[MODE_DOWNLOAD_BUTT];
...
extern int32 board_get_wifi_support_tas(void);
extern int32 board_get_wifi_tas_gpio_init_sts(int32 *gpio_sts);
#endif
