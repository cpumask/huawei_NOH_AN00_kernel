...
{
    memcpy_s(puc_addr, WLAN_MAC_ADDR_LEN, puc_mac_hdr + 4, WLAN_MAC_ADDR_LEN);
}


OAL_STATIC OAL_INLINE oal_void mac_get_address2  (oal_uint8 *puc_mac_hdr, oal_uint8 *puc_addr)
{
    memcpy_s(puc_addr, WLAN_MAC_ADDR_LEN, puc_mac_hdr + 10, WLAN_MAC_ADDR_LEN);
}

OAL_STATIC OAL_INLINE oal_void  mac_get_address3(oal_uint8 *puc_mac_hdr, oal_uint8 *puc_addr)
{
    memcpy_s(puc_addr, WLAN_MAC_ADDR_LEN, puc_mac_hdr + 16, WLAN_MAC_ADDR_LEN);
}
