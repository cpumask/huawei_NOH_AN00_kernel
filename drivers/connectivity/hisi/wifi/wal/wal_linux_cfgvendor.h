...
enum wal_vendor_subcmd {
    ...
    VENDOR_WIFI_SUBCMD_GET_FEATURE_SET,
    VENDOR_WIFI_SUBCMD_GET_FEATURE_SET_MATRIX,
    VENDOR_WIFI_RANDOM_MAC_OUI,
    VENDOR_WIFI_NODFS_CHANNELS,
    VENDOR_WIFI_SET_COUNTRY,
...
enum vendor_wifi_attr {
    VENDOR_WIFI_ATTRIBUTE_NUM_FEATURE_SET,
    VENDOR_WIFI_ATTRIBUTE_FEATURE_SET,
    VENDOR_WIFI_ATTRIBUTE_RANDOM_MAC_OUI,
    VENDOR_WIFI_ATTRIBUTE_NODFS_SET,
    VENDOR_WIFI_ATTRIBUTE_COUNTRY
};
