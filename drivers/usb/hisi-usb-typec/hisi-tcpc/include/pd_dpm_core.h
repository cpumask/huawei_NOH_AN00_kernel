...
void hisi_pd_dpm_dfp_inform_svids(
			pd_port_t *pd_port, pd_event_t *pd_event, bool ack);
void hisi_pd_dpm_dfp_inform_modes(
			pd_port_t *pd_port, pd_event_t *pd_event, bool ack);
void hisi_pd_dpm_dfp_inform_enter_mode(
	pd_port_t *pd_port, pd_event_t *pd_event, bool ack);
...
void hisi_pd_dpm_dfp_inform_uvdm(pd_port_t *pd_port, pd_event_t *pd_event, bool ack);
...
static inline int pd_dpm_sink_vbus(pd_port_t *pd_port, bool en)
{
	...
	return tcpci_sink_vbus(pd_port->tcpc_dev, TCP_VBUS_CTRL_REQUEST, mv, -1);
}
...
extern bool hisi_dp_dfp_u_notify_discover_id(pd_port_t *pd_port,
	svdm_svid_data_t *svid_data, pd_event_t *pd_event, bool ack);

extern bool hisi_dp_dfp_u_notify_discover_svid(
	pd_port_t *pd_port, svdm_svid_data_t *svid_data, bool ack);

extern bool hisi_dp_dfp_u_notify_discover_modes(
	pd_port_t *pd_port, svdm_svid_data_t *svid_data, bool ack);


extern bool hisi_dp_dfp_u_notify_enter_mode(pd_port_t *pd_port,
	svdm_svid_data_t *svid_data, uint8_t ops, bool ack);

extern bool hisi_dp_dfp_u_notify_exit_mode(
	pd_port_t *pd_port, svdm_svid_data_t *svid_data, uint8_t ops);

extern bool hisi_dp_dfp_u_notify_attention(pd_port_t *pd_port,
	svdm_svid_data_t *svid_data, pd_event_t *pd_event);
#endif	/* CONFIG_USB_PD_ALT_MODE_DFP_SUPPORT */

extern void hisi_dp_ufp_u_request_enter_mode(
	pd_port_t *pd_port, svdm_svid_data_t *svid_data, uint8_t ops);

extern void hisi_dp_ufp_u_request_exit_mode(
	pd_port_t *pd_port, svdm_svid_data_t *svid_data, uint8_t ops);

#ifdef CONFIG_USB_PD_ALT_MODE_DFP_SUPPORT
extern bool hisi_dp_dfp_u_notify_pe_startup(
	pd_port_t *pd_port, svdm_svid_data_t *svid_data);

extern int hisi_dp_dfp_u_notify_pe_ready(pd_port_t *pd_port,
	svdm_svid_data_t *svid_data, pd_event_t *pd_event);
#endif	/* CONFIG_USB_PD_ALT_MODE_DFP_SUPPORT */

extern bool hisi_dp_reset_state(
	pd_port_t *pd_port, svdm_svid_data_t *svid_data);
