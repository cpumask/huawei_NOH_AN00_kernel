...
static inline void tcpc_clear_timer_tick(struct tcpc_device *tcpc, uint32_t nr)
{
	unsigned long flags;
...
static inline void tcpc_set_timer_tick(struct tcpc_device *tcpc, uint32_t nr)
{
	unsigned long flags;
