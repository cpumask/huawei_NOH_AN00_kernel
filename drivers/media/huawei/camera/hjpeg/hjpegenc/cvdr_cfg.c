...
int dump_cvdr_debug_reg(hjpeg_hw_ctl_t *hw_ctl)
{
	...
	cam_info("%s: CVDR reg:\n 0x%08x=0x%08x\n 0x%08x=0x%08x\n 0x%08x=0x%08x", __func__,
		CVDR_AXI_JPEG_CVDR_CFG, get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_CVDR_CFG)),
		CVDR_AXI_JPEG_CVDR_WR_QOS_CFG, get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_CVDR_WR_QOS_CFG)),
		CVDR_AXI_JPEG_CVDR_RD_QOS_CFG, get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_CVDR_RD_QOS_CFG)));

	if (hw_ctl->cvdr_prop.wr_port == WR_PORT_25) {
		if (get_hjpeg_wr_port_addr_update()) {
			cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_SRT_VP_WR_CFG_25_OFFSET_UPDATE,
				get_reg_val((void __iomem*)((char*)viraddr + CVDR_SRT_VP_WR_CFG_25_OFFSET_UPDATE)));
			cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_SRT_VP_WR_AXI_FS_25_OFFSET_UPDATE,
				get_reg_val((void __iomem*)((char*)viraddr + CVDR_SRT_VP_WR_AXI_FS_25_OFFSET_UPDATE)));
			cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_SRT_VP_WR_AXI_LINE_25_OFFSET_UPDATE,
				get_reg_val((void __iomem*)((char*)viraddr + CVDR_SRT_VP_WR_AXI_LINE_25_OFFSET_UPDATE)));
			cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_SRT_VP_WR_IF_CFG_25_OFFSET_UPDATE,
				get_reg_val((void __iomem*)((char*)viraddr + CVDR_SRT_VP_WR_IF_CFG_25_OFFSET_UPDATE)));
			cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_LIMITER_VP_WR_25_OFFSET,
				get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_LIMITER_VP_WR_25_OFFSET)));
			cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_VP_WR_DEBUG_25_OFFSET,
				get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_VP_WR_DEBUG_25_OFFSET)));
		}
	} else if (hw_ctl->cvdr_prop.wr_port == WR_PORT_30) {
		cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_VP_WR_CFG_30_OFFSET,
			get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_VP_WR_CFG_30_OFFSET)));
		cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_VP_WR_AXI_FS_30_OFFSET,
			get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_VP_WR_AXI_FS_30_OFFSET)));
		cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_VP_WR_AXI_LINE_30_OFFSET,
			get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_VP_WR_AXI_LINE_30_OFFSET)));
		cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_VP_WR_IF_CFG_30_OFFSET,
			get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_VP_WR_IF_CFG_30_OFFSET)));
		cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_LIMITER_VP_WR_30_OFFSET,
			get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_LIMITER_VP_WR_30_OFFSET)));
		cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_VP_WR_DEBUG_30_OFFSET,
			get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_VP_WR_DEBUG_30_OFFSET)));
	}

	if (hw_ctl->cvdr_prop.rd_port == RD_PORT_4) {
		cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_NR_RD_CFG_4,
			get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_NR_RD_CFG_4)));
		cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_NR_RD_DEBUG_4_OFFSET,
			get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_NR_RD_DEBUG_4_OFFSET)));
		cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, CVDR_AXI_JPEG_LIMITER_NR_RD_4,
			get_reg_val((void __iomem*)((char*)viraddr + CVDR_AXI_JPEG_LIMITER_NR_RD_4)));
	}
	if (hw_ctl->smmu_type == ST_SMMUV3) {
		for (i = CVDR_AXI_JPEG_DEBUG_0; i <= CVDR_AXI_JPEG_DEBUG_15; i += CVDR_AXI_JPEG_DEBUG_INTERTVAL)
			cam_info("%s: CVDR reg: 0x%08x=0x%08x", __func__, i, get_reg_val((void __iomem*)((char*)viraddr + i)));
	}
	return 0;
}
...
static void hjpeg_config_axi_if_cfg(hjpeg_hw_ctl_t *hw_ctl, u32 vp_wr_if_cfg_offset)
{
	void __iomem *cvdr_srt_base = hw_ctl->cvdr_viraddr;
	bool flag = false;

	U_VP_WR_AXI_IF_CFG  axi_if_cfg;
	axi_if_cfg.reg32 = get_reg_val((void __iomem*)((char*)cvdr_srt_base + vp_wr_if_cfg_offset));
	// smmu bypass
	...
	if (flag) {
		set_reg_val((void __iomem*)((char*)cvdr_srt_base + vp_wr_if_cfg_offset), axi_if_cfg.reg32);
	}
}
...
static int set_vp_wr_ready(hjpeg_hw_ctl_t *hw_ctl, jpgenc_config_t* config)
{
	...
	hjpeg_config_axi_if_cfg(hw_ctl, vp_wr_if_cfg_offset);
...
static int set_nr_rd_config(hjpeg_hw_ctl_t *hw_ctl)
{
	...
	tmp.bits.nr_rd_stop_enable_flux_ctrl_1 = (hw_ctl->smmu_type == ST_SMMUV3) ? 0 : 1;
