...
/**
 * kbase_sys_cahce_init - init sys cache
 *
 * @kctx:  kbase context.
 */
int kbase_sys_cahce_init(struct kbase_context *kctx);

/**
 * kbase_sys_cahce_term - term sys cache
 *
 * @kctx:  kbase context.
 */
void kbase_sys_cahce_term(struct kbase_context *kctx);
#endif
