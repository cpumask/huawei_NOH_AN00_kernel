 ...
 * clk-balt.c
 *
 * Hisilicon balt es clock config
 *
...
CLK_OF_DECLARE_DRIVER(hisi_clk_peri_crgctrl,
	"hisilicon,clk-extreme-crgctrl", hisi_clk_crgctrl_init);
...
CLK_OF_DECLARE_DRIVER(hisi_clk_hsdtcrg,
	"hisilicon,clk-extreme-hsdt-crg", hisi_clk_hsdt_init);
...
CLK_OF_DECLARE_DRIVER(hisi_clk_hsdt1crg,
	"hisilicon,clk-extreme-hsdt1-crg", hisi_clk_hsdt1_init);
...
CLK_OF_DECLARE_DRIVER(hisi_clk_sctrl,
	"hisilicon,clk-extreme-sctrl", hisi_clk_sctrl_init);
...
CLK_OF_DECLARE_DRIVER(hisi_clk_media1crg,
	"hisilicon,clk-extreme-media1-crg", hisi_clk_media1_init);
...
CLK_OF_DECLARE_DRIVER(hisi_clk_media2crg,
	"hisilicon,clk-extreme-media2-crg", hisi_clk_media2_init);
...
CLK_OF_DECLARE_DRIVER(hisi_clk_iomcu,
	"hisilicon,clk-extreme-iomcu-crg", hisi_clk_iomcu_init);
...
CLK_OF_DECLARE_DRIVER(hisi_clk_xfreq,
	"hisilicon,clk-extreme-xfreq", hisi_clk_xfreq_init);
...
CLK_OF_DECLARE_DRIVER(hisi_clk_pmu,
	"hisilicon,clk-extreme-pmu", hisi_clk_pmu_init);
...
CLK_OF_DECLARE_DRIVER(hisi_clk_fast_dvfs,
	"hisilicon,clk-extreme-fast-dvfs", hisi_clk_fast_dvfs_init);
...
CLK_OF_DECLARE_DRIVER(hisi_clk_dvfs,
	"hisilicon,clk-extreme-dvfs", hisi_clk_dvfs_init);
