...
static ssize_t store_selftest(struct device *dev, struct device_attribute *attr, const char *buf, size_t size)
{
	...
	if (val == 1) {
		...
		if (WAIT_FOR_MCU_RESP_DATA_AFTER_SEND(&cpkt, inputhub_mcu_write_cmd(&cpkt,
			sizeof(cpkt)), 4000, &resp_pkt, sizeof(resp_pkt)) == 0) {
...
static ssize_t show_als_debug_data(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	if (rohm_rgb_flag == 1) {
		/* 0: cofficient_judge */
		als_debug_para[0] = als_para_diff_tp_color_table[als_para_table].bh745_para[0];
		/* 1: cofficient_red[0] */
		als_debug_para[1] = als_para_diff_tp_color_table[als_para_table].bh745_para[1];
		/* 3: cofficient_green[0] */
		als_debug_para[2] = als_para_diff_tp_color_table[als_para_table].bh745_para[3];
		/* 2: cofficient_red[1] */
		als_debug_para[3] = als_para_diff_tp_color_table[als_para_table].bh745_para[2];
		/* 4: cofficient_green[1] */
		als_debug_para[4] = als_para_diff_tp_color_table[als_para_table].bh745_para[4];
	...
	/* apds251_para or apds9253_para */
		...
		/* 9: avago_cofficient[1] */
		als_debug_para[1] = apds_als_para_diff_tp_color_table[als_para_table].apds251_para[9];
		/* 10: avago_cofficient[2] */
		als_debug_para[2] = apds_als_para_diff_tp_color_table[als_para_table].apds251_para[10];
		/* 20: avago_cofficient[3] */
		als_debug_para[3] = apds_als_para_diff_tp_color_table[als_para_table].apds251_para[20];
		/* 2: LUX_P */
		als_debug_para[4] = apds_als_para_diff_tp_color_table[als_para_table].apds251_para[2];
		/* 4: LUX_R */
		als_debug_para[5] = apds_als_para_diff_tp_color_table[als_para_table].apds251_para[4];
		/* 3: LUX_Q */
		als_debug_para[6] = apds_als_para_diff_tp_color_table[als_para_table].apds251_para[3];
		/* 19: lux_mix */
		als_debug_para[7] = apds_als_para_diff_tp_color_table[als_para_table].apds251_para[19];
		hwlog_info("%s:avago_rgb_flag is true and als_para_table=%d\n", __func__, als_para_table);
	/* apds9999_para */
	} else if (apds9999_rgb_flag == 1) {
		/* 9: avago_cofficient[1] */
		als_debug_para[1] = apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[9];
		/* 10: avago_cofficient[2] */
		als_debug_para[2] = apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[10];
		/* 20: avago_cofficient[3] */
		als_debug_para[3] = apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[20];
		/* 2: LUX_P */
		als_debug_para[4] = apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[2];
		/* 4: LUX_R */
		als_debug_para[5] = apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[4];
		/* 3: LUX_Q */
		als_debug_para[6] = apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[3];
		/* 19: lux_mix */
		als_debug_para[7] = apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[19];
		hwlog_info("%s:apds9999_rgb_flag is true and als_para_table=%d\n", __func__, als_para_table);
	/* tmd3725_para */
	} else if (ams_tmd3725_rgb_flag == 1) {
		/* 0: atime */
		als_debug_para[1] = tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[0];
		/* 1: again */
		als_debug_para[2] = tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[1];
		/* 2: dgf */
		als_debug_para[3] = tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[2];
		/* 3: c_coef */
		als_debug_para[4] = tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[3];
		/* 4: r_coef */
		als_debug_para[5] = tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[4];
		/* 5: g_coef */
		als_debug_para[6] = tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[5];
		/* 6: b_coef */
		als_debug_para[7] = tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[6];
		hwlog_info("%s:ams_tmd3725_rgb_flag is true and als_para_table=%d\n", __func__, als_para_table);
	/* tmd3702_para */
	} else if (ams_tmd3702_rgb_flag == 1) {
		/* 0: atime */
		als_debug_para[1] = tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[0];
		/* 1: again */
		als_debug_para[2] = tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[1];
		/* 2: dgf */
		als_debug_para[3] = tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[2];
		/* 3: c_coef */
		als_debug_para[4] = tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[3];
		/* 4: r_coef */
		als_debug_para[5] = tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[4];
		/* 5: g_coef */
		als_debug_para[6] = tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[5];
		/* 6: b_coef */
		als_debug_para[7] = tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[6];
	...
	/* liteon_ltr582_rgb_flag */
	} else if (liteon_ltr582_rgb_flag == 1) {
		/* 3: ad_radio */
		als_debug_para[1] = ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[3];
		/* 4: dc_radio */
		als_debug_para[2] = ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[4];
		/* 5: a_winfac */
		als_debug_para[3] = ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[5];
		/* 6: d_winfac */
		als_debug_para[4] = ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[6];
		/* 7: c_winfac */
		als_debug_para[5] = ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[7];
		/* 8: slope */
		als_debug_para[6] = ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[8];
		/* 9: slope_offset */
		als_debug_para[7] = ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[9];
		hwlog_info("%s:liteon_ltr582_rgb_flag is true and als_para_table=%d\n", __func__, als_para_table);
	} else if (tmd2745_flag == 1) {
		/* 0: D_factor */
		als_debug_para[0] = tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[0];
		/* 1: B_Coef */
		als_debug_para[1] = tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[1];
		/* 2: C_Coef */
		als_debug_para[2] = tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[2];
		/* 3: D_Coef */
		als_debug_para[3] = tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[3];
		/* 4: is_min_algo */
		als_debug_para[4] = tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[4];
		/* 5: is_auto_gain */
		als_debug_para[5] = tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[5];
		hwlog_info("%s:tmd2745_flag is true and als_para_table=%d.\n", __func__, als_para_table);
	}

	return snprintf(buf, BUF_SIZE, "%hd,%hd,%hd,%hd,%hd,%hd,%hd,%hd\n",
		als_debug_para[0], als_debug_para[1], als_debug_para[2], als_debug_para[3],
		als_debug_para[4], als_debug_para[5], als_debug_para[6], als_debug_para[7]);
}
...
static ssize_t store_als_debug_data(struct device *dev, struct device_attribute *attr, const char *buf, size_t size)
{
	...
	if (sscanf(buf, "%hd,%hd,%hd,%hd,%hd,%hd,%hd,%hd",
		&als_debug_para[0], &als_debug_para[1], &als_debug_para[2], &als_debug_para[3],
		&als_debug_para[4], &als_debug_para[5], &als_debug_para[6], &als_debug_para[7]))
	...
	if (rohm_rgb_flag == 1) {
		/* 0: cofficient_judge */
		als_para_diff_tp_color_table[als_para_table].bh745_para[0] = als_debug_para[0];
		/* 1: cofficient_red[0] */
		als_para_diff_tp_color_table[als_para_table].bh745_para[1] = als_debug_para[1];
		/* 2: cofficient_green[0] */
		als_para_diff_tp_color_table[als_para_table].bh745_para[3] = als_debug_para[2];
		/* 3: cofficient_red[1] */
		als_para_diff_tp_color_table[als_para_table].bh745_para[2] = als_debug_para[3];
		/* 4: cofficient_green[1] */
		als_para_diff_tp_color_table[als_para_table].bh745_para[4] = als_debug_para[4];
		hwlog_info("%s:rohm_rgb_flag is true and als_para_table=%d\n", __func__, als_para_table);
	...
	/* apds251_para */
		...
		/* 9: avago_cofficient[1] */
		apds_als_para_diff_tp_color_table[als_para_table].apds251_para[9] = als_debug_para[1];
		/* 10: avago_cofficient[2] */
		apds_als_para_diff_tp_color_table[als_para_table].apds251_para[10] = als_debug_para[2];
		/* 20: avago_cofficient[3] */
		apds_als_para_diff_tp_color_table[als_para_table].apds251_para[20] = als_debug_para[3];
		/* 2: LUX_P */
		apds_als_para_diff_tp_color_table[als_para_table].apds251_para[2] = als_debug_para[4];
		/* 4: LUX_R */
		apds_als_para_diff_tp_color_table[als_para_table].apds251_para[4] = als_debug_para[5];
		/* 3: LUX_Q */
		apds_als_para_diff_tp_color_table[als_para_table].apds251_para[3] = als_debug_para[6];
		/* 19: lux_mix */
		apds_als_para_diff_tp_color_table[als_para_table].apds251_para[19] = als_debug_para[7];
		hwlog_info("%s:avago_rgb_flag is true and als_para_table=%d\n", __func__, als_para_table);
	...
	/* apds9999_para */
		...
		/* 9: avago_cofficient[1] */
		apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[9] = als_debug_para[1];
		/* 10: avago_cofficient[2] */
		apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[10] = als_debug_para[2];
		/* 20: avago_cofficient[3] */
		apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[20] = als_debug_para[3];
		/* 2: LUX_P */
		apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[2] = als_debug_para[4];
		/* 4: LUX_R */
		apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[4] = als_debug_para[5];
		/* 3: LUX_Q */
		apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[3] = als_debug_para[6];
		/* 19: lux_mix */
		apds9999_als_para_diff_tp_color_table[als_para_table].apds9999_para[19] = als_debug_para[7];
		hwlog_info("%s:apds9999_rgb_flag is true and als_para_table=%d.\n", __func__, als_para_table);
	...
	/* tmd3725 */
		...
		/* 1: atime */
		tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[0] = als_debug_para[1];
		/* 2: again */
		tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[1] = als_debug_para[2];
		/* 3: dgf */
		tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[2] = als_debug_para[3];
		/* 4: c_coef */
		tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[3] = als_debug_para[4];
		/* 5: r_coef */
		tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[4] = als_debug_para[5];
		/* 6: g_coef */
		tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[5] = als_debug_para[6];
		/* 7: b_coef */
		tmd3725_als_para_diff_tp_color_table[als_para_table].tmd3725_para[6] = als_debug_para[7];
	...
	/* tmd3702 */
		...
		/* 1: atime */
		tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[0] = als_debug_para[1];
		/* 2: again */
		tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[1] = als_debug_para[2];
		/* 3: dgf */
		tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[2] = als_debug_para[3];
		/* 4: c_coef */
		tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[3] = als_debug_para[4];
		/* 5: r_coef */
		tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[4] = als_debug_para[5];
		/* 6: g_coef */
		tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[5] = als_debug_para[6];
		/* 7: b_coef */
		tmd3702_als_para_diff_tp_color_table[als_para_table].tmd3702_para[6] = als_debug_para[7];
		hwlog_info("%s:tmd3725_rgb_flag is true and als_para_table=%d\n", __func__, als_para_table);
	...
	/* liteon_ltr582_rgb_flag */
		...
		/* 3: ad_radio */
		ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[3] = als_debug_para[1];
		/* 4: dc_radio */
		ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[4] = als_debug_para[2];
		/* 5: a_winfac */
		ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[5] = als_debug_para[3];
		/* 6: d_winfac */
		ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[6] = als_debug_para[4];
		/* 7: c_winfac */
		ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[7] = als_debug_para[5];
		/* 8: slope */
		ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[8] = als_debug_para[6];
		/* 9: slope_offset */
		ltr582_als_para_diff_tp_color_table[als_para_table].ltr582_para[9] = als_debug_para[7];
		hwlog_info("%s:liteon_ltr582_rgb_flag is true and als_para_table=%d\n", __func__, als_para_table);
		...
		/* 0: D_factor */
		tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[0] = als_debug_para[0];
		/* 1: B_Coef */
		tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[1] = als_debug_para[1];
		/* 2: C_Coef */
		tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[2] = als_debug_para[2];
		/* 3: D_Coef */
		tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[3] = als_debug_para[3];
		/* 4: is_min_algo */
		tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[4] = als_debug_para[4];
		/* 5: is_auto_gain */
		tmd2745_als_para_diff_tp_color_table[als_para_table].als_para[5] = als_debug_para[5];
		hwlog_info("%s:tmd2745_flag is true and als_para_table=%d.\n", __func__, als_para_table);
...
static ssize_t show_fingersense_latch_data(struct device *dev, struct device_attribute *attr, char *buf)
{
	...
	size = sizeof(fingersense_data) < MAX_STR_SIZE ? sizeof(fingersense_data) : MAX_STR_SIZE;
