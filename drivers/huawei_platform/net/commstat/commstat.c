 ...
 * Description: Provide bastet common stat.
...
{
	struct comm_stat *proc_entry = NULL;
...
int __init comm_stat_init(void)
{
	...
	comm_stats_procfile = proc_create_data("stats", S_IRUGO,
		comm_stats_procdir, &comm_stats_fops, NULL);
