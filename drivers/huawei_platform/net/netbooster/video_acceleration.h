 ...
 * Description: Video collaborative acceleration head file.
...
struct video_parameter {
	unsigned char video_seg_state;
	unsigned char video_protocol;
	unsigned char video_remaining_playtime;
	unsigned char video_status;
	unsigned short ave_code_rate;
	unsigned short seg_size;
	unsigned int video_ip;
	unsigned short video_port;
	unsigned char seg_duration;
