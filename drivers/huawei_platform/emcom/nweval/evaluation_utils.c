							...
							int32_t* rtt_array, int8_t rtt_array_length)
{
	...
	point_set* ptr_reference_probability_set = NULL;
	...
	case NETWORK_TYPE_WIFI:
		ptr_reference_probability_set = (point_set*)
	...
	reference_point_set = convert_probability_to_count(ptr_reference_probability_set,
												rtt_array_length);
	...
	result_index = find_nearest_reference_point(distance_squares,
											INDEX_QUALITY_LEVELS);
