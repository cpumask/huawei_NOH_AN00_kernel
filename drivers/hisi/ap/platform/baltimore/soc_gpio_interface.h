...
#define SOC_GPIO_GPIODATA_ADDR(base) ((base) + (0x000~0x3fcUL))
#define SOC_GPIO_GPIODIR_ADDR(base) ((base) + (0x400UL))
#define SOC_GPIO_GPIOIS_ADDR(base) ((base) + (0x404UL))
#define SOC_GPIO_GPIOIBE_ADDR(base) ((base) + (0x408UL))
#define SOC_GPIO_GPIOIEV_ADDR(base) ((base) + (0x40CUL))
#define SOC_GPIO_GPIOIE_ADDR(base) ((base) + (0x410UL))
#define SOC_GPIO_GPIOIE2_ADDR(base) ((base) + (0x500UL))
#define SOC_GPIO_GPIOIE3_ADDR(base) ((base) + (0x504UL))
#define SOC_GPIO_GPIOIE4_ADDR(base) ((base) + (0x508UL))
#define SOC_GPIO_GPIORIS_ADDR(base) ((base) + (0x414UL))
#define SOC_GPIO_GPIOMIS_ADDR(base) ((base) + (0x418UL))
#define SOC_GPIO_GPIOMIS2_ADDR(base) ((base) + (0x530UL))
#define SOC_GPIO_GPIOMIS3_ADDR(base) ((base) + (0x534UL))
#define SOC_GPIO_GPIOMIS4_ADDR(base) ((base) + (0x538UL))
#define SOC_GPIO_GPIOIC_ADDR(base) ((base) + (0x41CUL))
#define SOC_GPIO_GPIOAFSEL_ADDR(base) ((base) + (0x420UL))
#else
...
#define SOC_GPIO_GPIOIE4_ADDR(base) ((base) + (0x508))
...
#define SOC_GPIO_GPIOMIS4_ADDR(base) ((base) + (0x538))
...
typedef union
{
    ...
    struct
    {
        unsigned int interrupt4_mask : 8;
        unsigned int reserved : 24;
    } reg;
} SOC_GPIO_GPIOIE4_UNION;
#endif
#define SOC_GPIO_GPIOIE4_interrupt4_mask_START (0)
#define SOC_GPIO_GPIOIE4_interrupt4_mask_END (7)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int masked_interrupt4_status : 8;
        unsigned int reserved : 24;
    } reg;
} SOC_GPIO_GPIOMIS4_UNION;
#endif
#define SOC_GPIO_GPIOMIS4_masked_interrupt4_status_START (0)
#define SOC_GPIO_GPIOMIS4_masked_interrupt4_status_END (7)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
