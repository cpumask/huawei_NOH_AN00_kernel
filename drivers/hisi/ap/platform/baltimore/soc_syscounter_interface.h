...
#define SOC_SYSCOUNTER_CNTCR_ADDR(base) ((base) + (0x0000UL))
#define SOC_SYSCOUNTER_CNTSR_ADDR(base) ((base) + (0x0004UL))
#define SOC_SYSCOUNTER_CNTCV_L32_ADDR(base) ((base) + (0x0008UL))
#define SOC_SYSCOUNTER_CNTCV_H32_ADDR(base) ((base) + (0x000CUL))
#define SOC_SYSCOUNTER_CNTFID0_ADDR(base) ((base) + (0x0020UL))
#define SOC_SYSCOUNTER_CNTFID1_ADDR(base) ((base) + (0x0024UL))
#define SOC_SYSCOUNTER_CNTFID2_ADDR(base) ((base) + (0x0028UL))
