...
#define SOC_RTCTIMERWDT_WDLOAD_ADDR(base) ((base) + (0x0000UL))
#define SOC_RTCTIMERWDT_WDVALUE_ADDR(base) ((base) + (0x0004UL))
#define SOC_RTCTIMERWDT_WDCONTROL_ADDR(base) ((base) + (0x0008UL))
#define SOC_RTCTIMERWDT_WDINTCLR_ADDR(base) ((base) + (0x000CUL))
#define SOC_RTCTIMERWDT_WDRIS_ADDR(base) ((base) + (0x0010UL))
#define SOC_RTCTIMERWDT_WDMIS_ADDR(base) ((base) + (0x0014UL))
#define SOC_RTCTIMERWDT_WDLOAD_B_ADDR(base) ((base) + (0x0018UL))
#define SOC_RTCTIMERWDT_WDLOCK_ADDR(base) ((base) + (0x0C00UL))
#else
...
#define SOC_RTCTIMERWDT_WDLOAD_B_ADDR(base) ((base) + (0x0018))
#define SOC_RTCTIMERWDT_WDLOCK_ADDR(base) ((base) + (0x0C00))
#endif
#ifndef __SOC_H_FOR_ASM__
#define SOC_RTCTIMERWDT_TIMER0_LOAD_ADDR(base) ((base) + (0x0000UL))
#define SOC_RTCTIMERWDT_TIMER1_LOAD_ADDR(base) ((base) + (0x0020UL))
#define SOC_RTCTIMERWDT_TIMER0_VALUE_ADDR(base) ((base) + (0x0004UL))
#define SOC_RTCTIMERWDT_TIMER1_VALUE_ADDR(base) ((base) + (0x0024UL))
#define SOC_RTCTIMERWDT_TIMER0_CONTROL_ADDR(base) ((base) + (0x0008UL))
#define SOC_RTCTIMERWDT_TIMER1_CONTROL_ADDR(base) ((base) + (0x0028UL))
#define SOC_RTCTIMERWDT_TIMER0_INTCLR_ADDR(base) ((base) + (0x000CUL))
#define SOC_RTCTIMERWDT_TIMER1_INTCLR_ADDR(base) ((base) + (0x002CUL))
#define SOC_RTCTIMERWDT_TIMER0_RIS_ADDR(base) ((base) + (0x0010UL))
#define SOC_RTCTIMERWDT_TIMER1_RIS_ADDR(base) ((base) + (0x0030UL))
#define SOC_RTCTIMERWDT_TIMER0_MIS_ADDR(base) ((base) + (0x0014UL))
#define SOC_RTCTIMERWDT_TIMER1_MIS_ADDR(base) ((base) + (0x0034UL))
#define SOC_RTCTIMERWDT_TIMER0_BGLOAD_ADDR(base) ((base) + (0x0018UL))
#define SOC_RTCTIMERWDT_TIMER1_BGLOAD_ADDR(base) ((base) + (0x0038UL))
#else
...
#endif
#ifndef __SOC_H_FOR_ASM__
#define SOC_RTCTIMERWDT_RTC_DR_ADDR(base) ((base) + (0x0000UL))
#define SOC_RTCTIMERWDT_RTC_MR_ADDR(base) ((base) + (0x0004UL))
#define SOC_RTCTIMERWDT_RTC_LR_ADDR(base) ((base) + (0x0008UL))
#define SOC_RTCTIMERWDT_RTC_CR_ADDR(base) ((base) + (0x000CUL))
#define SOC_RTCTIMERWDT_RTC_IMSC_ADDR(base) ((base) + (0x0010UL))
#define SOC_RTCTIMERWDT_RTCRIS_ADDR(base) ((base) + (0x0014UL))
#define SOC_RTCTIMERWDT_RTCMIS_ADDR(base) ((base) + (0x0018UL))
#define SOC_RTCTIMERWDT_RTCICR_ADDR(base) ((base) + (0x001CUL))
#else
...
} SOC_RTCTIMERWDT_WDLOAD_B_UNION;
#endif
#define SOC_RTCTIMERWDT_WDLOAD_B_wdogload_b_START (0)
#define SOC_RTCTIMERWDT_WDLOAD_B_wdogload_b_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
