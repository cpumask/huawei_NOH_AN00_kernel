...
#define SOC_UART_UARTDR_ADDR(base) ((base) + (0x000UL))
#define SOC_UART_UARTRSR_UARTECR_ADDR(base) ((base) + (0x004UL))
#define SOC_UART_UARTFR_ADDR(base) ((base) + (0x018UL))
#define SOC_UART_UARTLPR_ADDR(base) ((base) + (0x020UL))
#define SOC_UART_UARTIBRD_ADDR(base) ((base) + (0x024UL))
#define SOC_UART_UARTFBRD_ADDR(base) ((base) + (0x028UL))
#define SOC_UART_UARTLCR_H_ADDR(base) ((base) + (0x02CUL))
#define SOC_UART_UARTCR_ADDR(base) ((base) + (0x030UL))
#define SOC_UART_UARTIFLS_ADDR(base) ((base) + (0x034UL))
#define SOC_UART_UARTIMSC_ADDR(base) ((base) + (0x038UL))
#define SOC_UART_UARTRIS_ADDR(base) ((base) + (0x03CUL))
#define SOC_UART_UARTMIS_ADDR(base) ((base) + (0x040UL))
#define SOC_UART_UARTICR_ADDR(base) ((base) + (0x044UL))
#define SOC_UART_UARTDMACR_ADDR(base) ((base) + (0x048UL))
#else
