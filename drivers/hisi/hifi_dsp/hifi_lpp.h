...
#define HIFI_PARA_DOWNLOAD_BUFFER_SIZE      (0x2000)
...
#define HIFI_UNSEC_RESERVE_SIZE             (0x48C00)
...
#define HIFI_WIRED_HEADSET_PARA_ADDR (HISI_AP_VIRTUAL_CALL_UPLINK_ADDR + HISI_AP_VIRTUAL_CALL_UPLINK_SIZE)
#define HIFI_UNSEC_RESERVE_ADDR (HIFI_WIRED_HEADSET_PARA_ADDR + HIFI_PARA_DOWNLOAD_BUFFER_SIZE)
