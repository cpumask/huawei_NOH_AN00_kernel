...
extern int hisi_peripheral_ntc_2_temp(struct periph_tsens_tm_device_sensor *chip,
				      int *temp, int ntc);
extern int hisi_peripheral_temp_2_ntc(struct periph_tsens_tm_device_sensor *chip,
				      int temp, u16 *ntc);
