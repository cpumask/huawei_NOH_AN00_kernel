#ifndef _HISI_HI6421V900_COUL_H_
#define _HISI_HI6421V900_COUL_H_
/*****************************************************************************************
* Filename:	hisi_hi6421v900_coul.h
*
* Discription:  hi6421v900 coulometer driver headfile.
...
#define HI6XXX_VOL_OFFSET_B_ADDR        PMIC_NP_OTP0_59_R_ADDR(0)
#define HI6XXX_VOL_OFFSET_A_ADDR_0      PMIC_NP_OTP0_59_R_ADDR(0)
#define HI6XXX_VOL_OFFSET_A_ADDR_1      PMIC_NP_OTP0_58_R_ADDR(0)
...
#define HI6XXX_SOH_TDIE_DATA_BASE       PMIC_ACRADC_TDIE_DATA_L_ADDR(0)

#define HI6XXX_SOH_EN_BASE              PMIC_SOH_EN_ADDR(0)
...
#define HI6XXX_ECO_VOL_FIFO_BASE        PMIC_V_OCV_PRE1_OUT0_ADDR(0)
#define HI6XXX_ECO_I_FIFO_BASE          PMIC_I_OCV_PRE1_OUT0_ADDR(0)
#define HI6XXX_ECO_TEMP_FIFO_BASE       PMIC_T_OCV_PRE1_OUT0_ADDR(0)
...
static int soh_adc_a = 1000;
static int soh_adc_b;
