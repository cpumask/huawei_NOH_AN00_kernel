...
#define HI6XXX_VOL_OFFSET_B_ADDR        PMIC_OTP_41_R_ADDR(0)
#define HI6XXX_VOL_OFFSET_A_ADDR_0      PMIC_OTP_41_R_ADDR(0)
#define HI6XXX_VOL_OFFSET_A_ADDR_1      PMIC_OTP_40_R_ADDR(0)
